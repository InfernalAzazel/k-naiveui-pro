...
`,isScriptLangTS:!0,isSetupScript:!0,docContent:"",docMeta:{}}}],importMap:{imports:{vue:()=>h(()=>import("./chunks/framework.C-mL38yw.js").then(n=>n.vue_runtime_esmBundler),[]),"vue/server-renderer":()=>h(()=>import("./chunks/index.diqxkePv.js"),__vite__mapDeps([2,1]))},scopes:{}},site:{assetsDir:"assets",base:"/k-naiveui-pro/"}}),(n,l)=>{const t=g("demo");return r(),d("div",null,[l[4]||(l[4]=s("h1",{id:"proqueryform",tabindex:"-1"},[i("ProQueryForm "),s("a",{class:"header-anchor",href:"#proqueryform","aria-label":'Permalink to "ProQueryForm"'},"​")],-1)),l[5]||(l[5]=s("blockquote",null,[s("p",null,"高级表单用于快速构建表单视图")],-1)),l[6]||(l[6]=s("h2",{id:"基础用法",tabindex:"-1"},[i("基础用法 "),s("a",{class:"header-anchor",href:"#基础用法","aria-label":'Permalink to "基础用法"'},"​")],-1)),E(t,{key:"ComponentsDemoProQueryForm1Vue"},{title:a(()=>l[0]||(l[0]=[])),description:a(()=>l[1]||(l[1]=[])),default:a(()=>[E(o(e))]),"code-ComponentsDemoProQueryForm1Vue":a(()=>l[2]||(l[2]=[s("div",{class:"language-vue vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"<"),s("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"template"),s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")]),i(`
