...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"}")]),s(`
`),i("span",{class:"line"}),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"script"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),_:1}),a[14]||(a[14]=F('<h2 id="属性-props" tabindex="-1"><strong>属性 (Props)</strong> <a class="header-anchor" href="#属性-props" aria-label="Permalink to &quot;**属性 (Props)**&quot;">​</a></h2><table tabindex="0"><thead><tr><th>参数</th><th>类型</th><th>默认值</th><th>描述</th></tr></thead><tbody><tr><td><strong>customClass</strong></td><td><code>string | string[] | Record&lt;string, boolean&gt;</code></td><td>—</td><td>自定义面包屑容器的类名，支持字符串、字符串数组或对象形式的类名</td></tr><tr><td><strong>customLinkClass</strong></td><td><code>string | string[] | Record&lt;string, boolean&gt;</code></td><td>—</td><td>自定义面包屑链接的类名，支持字符串、字符串数组或对象形式的类名</td></tr><tr><td><strong>options</strong></td><td><code>BreadcrumbOption[]</code></td><td><code>[]</code></td><td>面包屑导航项的配置数组，包含每个导航项的属性</td></tr><tr><td><strong>separator</strong></td><td><code>string | (() =&gt; JSX.Element)</code></td><td><code>&#39;/&#39;</code></td><td>分隔符，可以是字符串或返回 JSX 元素的函数</td></tr></tbody></table><h3 id="probreadcrumboption-配置" tabindex="-1"><strong>ProBreadcrumbOption 配置</strong> <a class="header-anchor" href="#probreadcrumboption-配置" aria-label="Permalink to &quot;**ProBreadcrumbOption 配置**&quot;">​</a></h3><table tabindex="0"><thead><tr><th>参数</th><th>类型</th><th>默认值</th><th>描述</th></tr></thead><tbody><tr><td><strong>label</strong></td><td><code>string</code></td><td><code>&#39;&#39;</code></td><td>导航项的显示文本</td></tr><tr><td><strong>path</strong></td><td><code>string</code></td><td><code>undefined</code></td><td>导航项的路径，点击后会通过事件传递给外部处理</td></tr><tr><td><strong>icon</strong></td><td><code>string</code></td><td><code>undefined</code></td><td>面包屑项的图标，传入 <code>@iconify/vue</code> 的图标名称</td></tr></tbody></table><h3 id="事件-emits" tabindex="-1"><strong>事件 (Emits)</strong> <a class="header-anchor" href="#事件-emits" aria-label="Permalink to &quot;**事件 (Emits)**&quot;">​</a></h3><table tabindex="0"><thead><tr><th>事件名</th><th>参数</th><th>描述</th></tr></thead><tbody><tr><td><strong>item-click</strong></td><td><code>(path: string)</code></td><td>当点击带有 path 属性的面包屑项时，会触发 item-click 事件，并将 path 作为参数传递出去，外部组件可以监听该事件并进行处理。</td></tr></tbody></table>',6))])}}});export{B as __pageData,b as default};
